  ...
  return (
    <section ref={sectionRef} className=" w-full px-5 font-primary  h-screen">
      <aside className="max-w-[1000px] mx-auto w-full gap-5 flex flex-col justify-center h-full text-gray-700">
        <p className="text-3xl md:text-4xl  studio-brief-paragraph font-medium">
          Most B2B companies have grown into businesses their website doesn't
          know about yet.
        </p>
        <div className="text-3xl md:text-4xl font-medium text-right">
        ...
        <p className="studio-brief-paragraph text-3xl md:text-4xl font-medium">
          All of them. Same tired website from three years ago.
        </p>
        <p className="studio-brief-paragraph text-3xl md:text-4xl font-medium text-right">
